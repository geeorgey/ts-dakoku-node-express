    ...
    <body>
        <article>
            ...
            <section style="margin: 20px; text-align: center; color: red;">
                ...
                <script>var date=new Date(window.demoVersion),month=date.toLocaleString("en-us",{month:"long"}),day=date.getDate();day.toString().length<=9&&(day=day.toString().length == 1 ? "0"+day : day);var year=date.getFullYear(); document.getElementById("demoVersion").innerHTML="Last Updated On: <time>"+month+" "+day+" "+year+"</time>";</script>
            </section>
